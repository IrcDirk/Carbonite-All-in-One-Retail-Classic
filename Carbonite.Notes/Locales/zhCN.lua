...
L["Route ZygorGuides arrow through Carbonite"] = "通过 Carbonite 引导 ZygorGuides 箭头"
L["Replaces the ZygorGuides navigation arrow with Carbonite's own HUD travel arrow, pointing at the current step"] = "用 Carbonite 自己的 HUD 导航箭头替换 ZygorGuides 的导航箭头，指向当前步骤"
