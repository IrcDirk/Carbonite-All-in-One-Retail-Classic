...
local L = LibStub("AceLocale-3.0"):NewLocale("Carbonite.Quest", "ptBR")
...
L["Watch Font Outline"] = "Contorno da fonte"
L["Sets the outline style of the quest watch font"] = "Define o estilo de contorno da fonte do monitor de missões"
L["Watch Font Shadow"] = "Sombra da fonte"
L["Adds a drop shadow to the quest watch font"] = "Adiciona uma sombra à fonte do monitor de missões"
L["None"] = "Nenhum"
L["Outline"] = "Contorno"
...
L["Show Quest Offers on Map"] = "Mostrar ofertas de missões no mapa"
L["When enabled, shows available quest offers from quest lines on the map"] = "Quando ativado, mostra ofertas de missões disponíveis das cadeias de missões no mapa"
L["Get Quests"] = "Obter missões"
...
L["Wowhead Link"] = true
L["Set as Active Quest"] = "Definir como missão ativa"
