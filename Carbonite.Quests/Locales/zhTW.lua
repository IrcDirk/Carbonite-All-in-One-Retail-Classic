...
local L = LibStub("AceLocale-3.0"):NewLocale("Carbonite.Quest", "zhTW")
...
L["Show Quest Offers on Map"] = "在地圖上顯示任務提供"
L["When enabled, shows available quest offers from quest lines on the map"] = "啟用後，在地圖上顯示任務鏈中可用的任務提供"
L["Get Quests"] = "獲取任務"
