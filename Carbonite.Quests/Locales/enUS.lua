...
L["Share Full and Minimized Watch Position"] = true
L["When enabled, the full and minimized quest watch use one screen position. Disable to save a separate position for each state."] = true
...
L["Daily PvP"] = true
L["Weekly"] = true
L["Hide Locked Quest Givers"] = true
L["Hide quest givers whose quests are still locked behind an unfinished prerequisite (otherwise they are dimmed and marked locked)"] = true
L["Aldor"] = true
L["Scryer"] = true
L["Consortium"] = true
...
-- World quest list
L["Open World Quest List"] = true
L["World Quest List"] = true
L["World Quest List (%d)"] = true
L["Name"] = true
L["Zone"] = true
L["Reward"] = true
L["Faction"] = true
...
L["PvP"] = true
L["Other"] = true
L["Show Gear Rewards"] = true
L["Show Gold Rewards"] = true
L["Show Currency, Material, and Reputation Rewards"] = true
L["Show Power Rewards"] = true
L["Show PVP Rewards"] = true
L["Show Other Rewards"] = true
L["Current Zone Only"] = true
L["Refresh World Quest List"] = true
L["No world quests are available in the current zone."] = true
L["No world quests are available in this region."] = true
L["World quest data is unavailable for this location."] = true
L["Click the icon to set a map target."] = true
L["Track World Quest"] = true
L["Untrack World Quest"] = true
L["Right-click the row to track or untrack this world quest."] = true

L["Quest Complete '%s'"] = true
L["Load quest data by threshold"] = true
L["Loads all the carbonite quest data between player level - level threshold to %s"] = true
L["Level Threshold"] = true
L["Levels under player level to load quest data on reload"] = true

L["Show Quest Offers on Map"] = true
L["When enabled, shows available quest offers from quest lines on the map"] = true
L["Get Quests"] = true
