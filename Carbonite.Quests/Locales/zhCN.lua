...
L["Watch Font Outline"] = "字体描边"
L["Sets the outline style of the quest watch font"] = "设置任务监视窗口字体的描边样式"
L["Watch Font Shadow"] = "字体阴影"
L["Adds a drop shadow to the quest watch font"] = "为任务监视窗口字体添加阴影"
L["None"] = "无"
L["Outline"] = "描边"
L["Thick Outline"] = "粗描边"
...
L["Loads all the carbonite quest data between player level - level threshold to %s"] = "载入玩家当前等级至%s级的任务数据"
