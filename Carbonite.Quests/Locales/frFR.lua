...
L["Watch Font Outline"] = "Contour de la police"
L["Sets the outline style of the quest watch font"] = "Définit le style de contour de la police de la fenêtre de suivi"
L["Watch Font Shadow"] = "Ombre de la police"
L["Adds a drop shadow to the quest watch font"] = "Ajoute une ombre portée à la police de la fenêtre de suivi"
L["None"] = "Aucun"
L["Outline"] = "Contour"
...
L["Show Quest Offers on Map"] = "Afficher les offres de quêtes sur la carte"
L["When enabled, shows available quest offers from quest lines on the map"] = "Si activé, affiche les offres de quêtes disponibles des chaînes de quêtes sur la carte"
L["Get Quests"] = "Obtenir les quêtes"
...
L["Set as Active Quest"] = "Définir comme quête active"
