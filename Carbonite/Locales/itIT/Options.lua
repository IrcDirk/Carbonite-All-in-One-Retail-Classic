...
L["Enable Combat Compatibility Mode"] = "Abilita Modalit\195\160 Compatibilit\195\160 Combattimento"
L["Take Map Function Control"] = "Prendi Controllo Funzioni Mappa"
L["When enabled Carbonite takes control of 2 blizzard map functions to help prevent map flickers, and unneccsary lag causing calls to change the map."] = "Quando abilitato, Carbonite prende il controllo di 2 funzioni della mappa Blizzard per prevenire sfarfallii e lag non necessario."
L["Hide Map In Combat"] = "Nascondi Mappa in Combattimento"
L["If large map is open when you enter combat attempts to hide it."] = "Se la mappa grande \195\168 aperta quando si entra in combattimento, tenta di nasconderla."
...
L["Map Health Bar Thickness"] = "Spessore Barra Salute Mappa"
L["Sets the thickness of the health bar (0 disables)"] = "Imposta lo spessore della barra della salute (0 disabilita)"
...
L["Sets the area size available when zoomed into satellite mode on the map (REQUIRES RELOAD)"] = "Imposta la dimensione dell'area disponibile quando si \195\168 in modalit\195\160 satellite sulla mappa (RICHIEDE /reload)"
...
L["Move capture bars under map"] = "Sposta barre di cattura sotto la mappa"
L["When enabled, Objective capture bars will be drawn under the map."] = "Quando abilitato, le barre di cattura obiettivi verranno disegnate sotto la mappa."
L["Show Old Nameplates"] = "Mostra Vecchie Targhette"
L["When enabled, The minimap will display the old nameplates above the map."] = "Quando abilitato, la minimappa mostrer\195\160 le vecchie targhette sopra la mappa."
...
L["Enable Dungeon Finder Minimap Button"] = "Abilita Pulsante Cerca Dungeon"
L["Shows the dungeon finder minimap button in the button panel"] = "Mostra il Pulsante Cerca Dungeon nella Barra dei Pulsanti della Minimappa"
...
L["Mining"] = "Estrazione"
L["Timber"] = "Legname"
L["Delete Timber Gather Locations"] = "Cancella Luoghi Raccolta Legname"
L["Small Timber"] = "Legname Piccolo"
L["Medium Timber"] = "Legname Medio"
L["Large Timber"] = "Legname Grande"
L["Show Timber Locations"] = "Mostra Posizioni Legname"
L["Lumbermill"] = "Segheria"
L["Delete"] = "Cancella"
L["Import"] = "Importa"
L["Cancel"] = "Annulla"
L["Enable All"] = "Abilita Tutto"
...
-- Track Options
L["Tracking Options"] = "Opzioni Tracciatura"
L["Hide Tracking HUD"] = "Nascondi HUD Tracciatura"
L["When Enabled, Carbonite will hide the tracking hud from display"] = "Quando abilitato, Carbonite nasconder\195\160 l'HUD di tracciatura"
L["Hide Tracking HUD in BG's"] = "Nascondi HUD Tracciatura nei CdB"
L["When Enabled, Carbonite will hide the tracking hud from display in Battlegrounds"] = "Quando abilitato, Carbonite nasconder\195\160 l'HUD di tracciatura nei Campi di Battaglia"
L["Lock Tracking HUD Position"] = "Blocca Posizione HUD Tracciatura"
L["When Enabled, Carbonite will lock the Tracking HUD in position"] = "Quando abilitato, Carbonite bloccher\195\160 la posizione dell'HUD di tracciatura"
L["Tracking HUD Arrow Graphic"] = "Grafica Freccia HUD Tracciatura"
L["Sets the current arrow to be used in the tracking hud"] = "Imposta la freccia corrente per l'HUD di tracciatura"
L["Arrow Size"] = "Dimensione Freccia"
L["Sets the number of size of the tracking hud arrow."] = "Imposta la dimensione della freccia dell'HUD di tracciatura."
L["Arrow X Offset"] = "Offset X Freccia"
L["Sets the X offset of the tracking hud arrow."] = "Imposta l'offset X della freccia dell'HUD di tracciatura."
L["Arrow Y Offset"] = "Offset Y Freccia"
L["Sets the Y offset of the tracking hud arrow."] = "Imposta l'offset Y della freccia dell'HUD di tracciatura."
L["Show Direction Text"] = "Mostra Testo Direzione"
L["When Enabled, shows additional direction text in the hud"] = "Quando abilitato, mostra un testo aggiuntivo sulla direzione nell'HUD"
L["Enable Target Button"] = "Abilita Pulsante Bersaglio"
L["When Enabled, Adds a target button to the tracking hud"] = "Quando abilitato, aggiunge un pulsante bersaglio all'HUD di tracciatura"
L["Color of target button"] = "Colore del pulsante bersaglio"
L["Color of target button in combat"] = "Colore del pulsante bersaglio in combattimento"
L["Enable Target Reached Sound"] = "Abilita Suono Destinazione Raggiunta"
L["When Enabled, Plays a sound when you reach your target destination"] = "Quando abilitato, riproduce un suono quando raggiungi la destinazione"
L["Auto Track Pals In BattleGrounds"] = "Traccia Automaticamente Amici nei CdB"
L["When Enabled, Will auto track your friends in battleground"] = "Quando abilitato, traccia automaticamente gli amici nei Campi di Battaglia"
L["Auto Track Taxi Destination"] = "Traccia Automaticamente Destinazione Taxi"
L["When Enabled, Will automatically track your taxi destination"] = "Quando abilitato, traccia automaticamente la destinazione del volo"
L["Auto Track Corpse"] = "Traccia Automaticamente Cadavere"
L["When Enabled, Will automatically track your corpse upon death"] = "Quando abilitato, traccia automaticamente il tuo cadavere alla morte"
L["Enable TomTom Emulation"] = "Abilita Emulazione TomTom"
L["When Enabled, Attempts to emulate tomtom's features (requires reload)"] = "Quando abilitato, tenta di emulare le funzioni di TomTom (richiede /reload)"
...
L["Profiles"] = "Profili"
L["Skin"] = "Aspetto"
L["Tracking HUD"] = "HUD Tracciatura"
