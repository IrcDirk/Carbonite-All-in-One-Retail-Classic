...
L["Enable Combat Compatibility Mode"] = "전투 호환 모드 사용"
L["Take Map Function Control"] = "지도 기능 제어 전환"
L["When enabled Carbonite takes control of 2 blizzard map functions to help prevent map flickers, and unneccsary lag causing calls to change the map."] = "사용할 경우, Carbonite가 2개의 블리자드 지도 기능을 제어하여 지도 깜빡임과 불필요한 렉을 방지합니다."
L["Hide Map In Combat"] = "전투 중 지도 숨기기"
L["If large map is open when you enter combat attempts to hide it."] = "전투에 돌입할 때 큰 지도가 열려 있으면 숨깁니다."
...
L["Mining"] = "광물 위치"
L["Timber"] = "목재"
L["Delete Timber Gather Locations"] = "목재 채집 위치 삭제"
L["Small Timber"] = "작은 목재"
L["Medium Timber"] = "중간 목재"
L["Large Timber"] = "큰 목재"
L["Show Timber Locations"] = "목재 위치 표시"
L["Lumbermill"] = "벌목장"
L["Delete"] = "삭제"
L["Import"] = "가져오기"
L["Cancel"] = "취소"
