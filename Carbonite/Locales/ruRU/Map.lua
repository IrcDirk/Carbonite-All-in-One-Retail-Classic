...
L["Show Herb Locations"] = "Показать отметки травы"
L["Show Mining Locations"] = "Показать отметки руды"
L["Show Timber Locations"] = "Показать отметки древесины"
L["Show Artifact Locations"] = "Показать артефакты"
L["Show Class Trainer"] = "Показать классовых тренеров"
L["Show Profession Trainers"] = "Показать тренеров профессий"
...
L["Show Gossip POIs"] = "Показать точки общения"
L["Show Bonus Objectives"] = "Показать дополнительные задачи"
L["Show Unexplored Areas"] = "Показать неисследованные зоны"
...
L["Show Instance Raid Bosses"] = "Показывать рейдовых боссов"
