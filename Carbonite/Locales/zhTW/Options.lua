...
L["Enable Combat Compatibility Mode"] = "開啟戰鬥相容模式"
L["Take Map Function Control"] = "接管地圖功能"
L["When enabled Carbonite takes control of 2 blizzard map functions to help prevent map flickers, and unneccsary lag causing calls to change the map."] = "啟用時，Carbonite會接管2個暴雪地圖功能，防止地圖閃爍，減少地圖切換時的卡頓。"
L["Hide Map In Combat"] = "戰鬥中隱藏大地圖"
L["If large map is open when you enter combat attempts to hide it."] = "進入戰鬥時隱藏大地圖"
...
L["Enable Dungeon Finder Minimap Button"] = "啟用副本搜尋器按鈕"
L["Shows the dungeon finder minimap button in the button panel"] = "在按鈕窗口顯示副本搜尋器按鈕"
...
L["Mining"] = "礦石"
L["Timber"] = "木材"
L["Delete Timber Gather Locations"] = "刪除木材採集位置"
L["Small Timber"] = "小型木材"
L["Medium Timber"] = "中型木材"
L["Large Timber"] = "大型木材"
L["Show Timber Locations"] = "顯示木材位置"
L["Lumbermill"] = "伐木場"
L["Delete"] = "刪除"
L["Import"] = "導入"
L["Cancel"] = "取消"
...
L["No"] = "否"
L["Ok"] = "確定"
L["Put the game minimap into the Carbonite map?\n\nThis will make one unified map. The minimap buttons will go into the Carbonite button window. This can also be changed using the Map Minimap options page."] = "將遊戲小地圖整入Carbonite地圖?\n\n這將創建一個統一的地圖。小地圖按鈕將會移入Carbonite按鈕窗口。此設置也可以在地圖小地圖選項頁中修改。"
L["Consider installing Carbonite.Combined.Maps.%s addon to gain FPS using compressed maps."] = "建議安裝Carbonite.Combined.Maps.%s插件以通過壓縮地圖提高FPS。"
