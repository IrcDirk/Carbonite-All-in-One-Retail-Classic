...
local FLIGHT_DATA = {
    ...
    ["2,1423,70.51,47.51"] = L["Light's Hope Chapel, Eastern Plaguelands"],
    ["2,1440,12.2,33.8"] = L["Zoram'gar Outpost, Ashenvale"],
    ["1,1423,71.77,49.49"] = L["Light's Hope Chapel, Eastern Plaguelands"],
    ...
    ["1,1433,25.6,59.4"] = L["Lakeshire, Redridge"],
    ...
    ["1,2548,60.6,81.6"] = L["Farholde Keep, Riverglades"],
}
